...
Shader "Space Game/Button Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float cos39 = cos( radians( 15.0 ) );
			float sin39 = sin( radians( 15.0 ) );
			float2 rotator39 = mul( (ase_vertex3Pos).xyz.xy - float2( 0,0 ) , float2x2( cos39 , -sin39 , sin39 , cos39 )) + float2( 0,0 );
...
/*ASEBEGIN
Version=15101
7;29;1906;1004;1666.237;5.820752;1.145801;True;True
...
Node;AmplifyShaderEditor.PosVertexDataNode;127;-952.4028,202.7147;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-710.4995,506.6423;Float;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;15;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;49;-320,160;Half;False;Property;_Speed;Speed;4;0;Create;True;0;0;False;0;-0.25,0;0.05,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;100;1498.695,803.7155;Float;False;Property;_CompletionColor;CompletionColor;7;0;Create;True;0;0;False;0;1,0,0,0;1,0,0.2274508,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;1;716.0012,-48.43496;Fixed;False;Property;_Color;Color;2;0;Create;True;0;0;False;0;0,0.6689653,1,1;0.5647059,0.3607831,0.9333333,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=6E5093817805C1D4E11EED73BDA35B3D5FC77796